...
const Login = ({ onLogin, API_URL = "https://expense-tracker-app-backend-wpiu.onrender.com" }) => {
        ...
        try {
            ...
            if (typeof onLogin === "function") {
                try {
                    ...
                    console.warn("onLoging threw:", callErr);
                    navigate("/");
                }
            } else {
                navigate("/");
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className='mb-6'>
                            ...
                            <div className={loginStyles.inputContainer}>
                                ...
                                <input type={showPassword ? "text" : "password"} id='password' value={password} onChange={(e) => setPassword(e.target.value)} className={loginStyles.passwordInput} placeholder="&bull; &bull; &bull; &bull; &bull; &bull;" required />
