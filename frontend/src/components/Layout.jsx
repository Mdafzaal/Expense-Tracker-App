...
import { Activity, ArrowDown, ArrowUp, Car, ChevronDown, ChevronUp, Clock, CreditCard, DollarSign, Gift, Home, Info, PieChart, PiggyBank, RefreshCcw, RefreshCw, ShoppingCart, TrendingUp, Utensils, Zap } from 'lucide-react';
...
const Layout = ({ onLogout, user }) => {
    ...
    // get stats date according to time
    const stats = useMemo(() => {
        const now = new Date();
                    ...
                    <div className={styles.statCards.card}>
                        <div className={styles.statCards.cardHeader}>
                            <div>
                                ...
                                <p className={styles.statCards.cardValue}>
                                    $
                                    {Number(stats?.allTimeSavings || 0).toLocaleString("en-IN", {
                        ...
                        <p className={styles.statCards.cardFooter}>
                            <span className='text-teal-600'>
                                +${Number(stats.last30DaysSavings || 0).toLocaleString("en-IN")}
                            </span>{" "}
                            this month
                        </p>
                    </div>
                    ...
                    <div className={styles.statCards.card}>
                        <div className={styles.statCards.cardHeader}>
                            <div>
                                ...
                                <p className={styles.statCards.cardValue}>
                                    $
                                    {Number(stats?.last30DaysIncome || 0).toLocaleString("en-IN", {
                                        maximumFractionDigits: 2,
                                    })}
                                </p>
                            </div>
                    ...
                    <div className={styles.statCards.card}>
                        <div className={styles.statCards.cardHeader}>
                            <div>
                                ...
                                <p className={styles.statCards.cardValue}>
                                    $
                                    {Number(stats?.last30DaysExpenses || 0).toLocaleString("en-IN", {
                                        maximumFractionDigits: 2,
                                    })}
                                </p>
                            </div>
